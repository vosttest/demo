...
namespace TVA.DAL
{
    ...
    public class UserRep : GenericRep<ZContext, User>
    {
        ...
        public override SingleRsp Create(List<User> l)
        {
        ...
        public override IQueryable<User> Read(Expression<Func<User, bool>> p)
        {
            return base.Read(p);
        }
        ...
        {
            var res = All.FirstOrDefault(p => p.UserName == code);
            return res;
        }
        ...
        public override SingleRsp Update(User m)
        {
            ...
            var t = m.Id > 0 ? Read(m.Id) : Read(m.UserName);
            if (t == null)
            {
        ...
        /// <param name="l">List model</param>
        /// <returns>Return the result</returns>
        public override SingleRsp Update(List<User> l)
        {
