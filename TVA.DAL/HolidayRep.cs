...
namespace TVA.DAL
{
    ...
    /// Holiday repository
    /// </summary>
    public class HolidayRep : GenericRep<ZContext, Holiday>
    {
        #region -- Overrides --
        ...
        public override SingleRsp Create(Holiday m)
        {
            ...
            var t = Read(m.Day, m.Month, m.Year);
            if (t != null)
            {
        ...
        public override SingleRsp Create(List<Holiday> l)
        {
        ...
        public override IQueryable<Holiday> Read(Expression<Func<Holiday, bool>> p)
        {
            return base.Read(p);
        }
        ...
        /// <returns>Return the object</returns>
        public override Holiday Read(long id)
        {
        ...
        /// <returns>Return the object</returns>
        public override Holiday Read(string code)
        {
            var res = All.FirstOrDefault(p => p.Day == code);
            return res;
        }
        ...
        /// <param name="m">The model</param>
        /// <returns>Return the result</returns>
        public override SingleRsp Update(Holiday m)
        {
            var res = new SingleRsp();
        ...
        /// <param name="l">List model</param>
        /// <returns>Return the result</returns>
        public override SingleRsp Update(List<Holiday> l)
        {
        ...
        /// </summary>
        public override IQueryable<Holiday> All
        {
            get
            {
        ...
        /// <returns>Return the result</returns>
        public Holiday Read(string day, string month, string year)
        {
            var res = All.FirstOrDefault(p => p.Day == day && p.Month == month && p.Year == year);
            return res;
        }
